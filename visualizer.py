...
class Visualizer:
    ...
    def yield_subsets(self):
        ...
        yield self.loadmodel(0), feats[initl], labls[initl], None
    ...
    def makeaxes(self, n):
        plt.close('all')
        plt.tight_layout()
        fig, ax = plt.subplots(ncols=n, sharex=False, figsize=(10, 5))
    ...
    def graph(self):
        ...
        for i, subs in enumerate(self.yield_subsets()):
            model, x, y, scores = subs
            fig = g(x, y, model, scores, i)
